...
class CustomFedAvg(FedAvg):
    def __init__(self, *args, tb_log_dir: str = "tb_logs", tb_run_name: str = "tb_run", **kwargs):
    ...
    def evaluate(self, server_round, parameters):
        ...
        parameters_ndarrays = parameters_to_ndarrays(parameters)
        loss, metrics, run_config = self.evaluate_fn(server_round, parameters_ndarrays, {}, self.visualize_and_log_predictions)
    ...
    def visualize_and_log_predictions(
        ...
        self.writer.add_figure(f'predictions', fig, round)
        plt.close(fig) 
